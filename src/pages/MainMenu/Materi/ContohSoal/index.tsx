...
const Soal = ({ route, navigation }) => {
  ...
  if (loading) {
    return (
      <ContainerWithHeader title={"Contoh Soal"}>
    ...
    <ContainerWithHeader title={"Contoh Soal"}>
      <View>
        <View style={{ marginTop: windowWidth * 0.02 }}>
          ...
          {currentQuestion && (
          <View style={[styles.card, { width: windowWidth * 0.8, borderRadius: 10, marginBottom: windowHeight * 0.02, height: windowHeight * 0.5 }]}>
            {currentQuestion.questionImage && (
              <View style={{ backgroundColor: 'white', height: windowHeight * 0.25, alignItems: 'center', justifyContent: 'center' }}>
                <Image
